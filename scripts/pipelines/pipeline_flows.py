...
def load_aspect_flow():
    ...
    aspect_loader = model.DataLoader(table_name, load_file, database_name, "raster")
...
def load_slope_flow():
    ...
    slope_loader = model.DataLoader(table_name, load_file, database_name, "raster")
...
def transform_ESA_NA_dem_90_vrt_flow():
    ...
    esa_NA_dem_vrt_90_transformer = model.DataTransformer(files_dir)
...
def transform_ESA_NA_dem_30_vrt_flow():
    ...
    esa_NA_dem_vrt_30_transformer = model.DataTransformer(input_dir)
...
def transform_ESA_global_dem_90_vrt_flow():
    ...
    esa_global_dem_vrt_90_transformer = model.DataTransformer(input_dir)
...
def transform_ESA_world_cover_vrt_flow():
    ...
    esa_world_cover_transformer = model.DataTransformer(esa_world_cover_dir)
...
def transform_geomorphon_flow():
    ...
    geomorphon_transformer = model.DataTransformer(input_raster)
